...
\begin{figure}[ht]
  ...
  \caption{Differential expression of unannotated human endogenous retroviral loci}
  \label{fig:dge_res}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Global estimates of proviral expression across tissue phenotypes}
  \label{fig:heat}
\end{figure}
